  ...
  return (
    <main className="section-padding">
      <div className="mx-auto max-w-2xl rounded-3xl border border-sand-200 bg-white p-8 text-center shadow-soft dark:border-slate-800 dark:bg-slate-900">
        ...
        <h1 className="mt-4 text-3xl font-semibold text-slate-900 dark:text-white">Página não encontrada</h1>
        <p className="mt-3 text-sm text-slate-600 dark:text-slate-300">
          Este link não abriu corretamente. Copie a rota abaixo para verificarmos o que chegou no celular.
        </p>
