...
const page = getSeoIntentPage('pontos-comerciais-a-venda')!;
...
export const metadata: Metadata = {
  ...
  keywords: [
    'ponto comercial a venda RN',
    'ponto comercial à venda Natal',
    'loja a venda RN',
    'sala comercial a venda RN',
    'imóvel comercial a venda Rio Grande do Norte'
  ],
