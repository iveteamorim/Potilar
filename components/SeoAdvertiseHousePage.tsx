    ...
    <main className="section-padding">
      <div className="mx-auto max-w-5xl space-y-8">
        <section className="max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-ocean-600">Anunciar gratis</p>
        ...
        <section className="grid gap-4 md:grid-cols-3">
          {[
            'Publique fotos, preco, cidade e detalhes do imovel.',
            'Receba interessados direto pelo contato escolhido.',
            `Pagina indicada para quem quer ${intentLabel} no Rio Grande do Norte.`
          ].map((item) => (
